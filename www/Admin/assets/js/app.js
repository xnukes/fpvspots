		...
		if(_container_1.length > 0) {
			...
			loadScript(plugin_path + 'editor.summernote/summernote.js', function() {
				...
				if(jQuery().summernote) {
                    ...
                    loadScript(plugin_path + 'editor.summernote/summernote-ext-addclass.js');
					...
					_container_1.each(function() {
						...
						if(_lang != 'en-US') {
							loadScript(plugin_path + 'editor.summernote/lang/summernote-'+_lang+'.js', function () {
								console.log('Summernote Lang: ' + _lang);
                            });
						}
